...
class ModelArguments:
    ...
    lora: bool = field(default=False,
                       metadata={
                           "help": "do parameter-efficient fine-tuning with lora"}
                       )
...
class DataArguments:
    ...
    corpus_name: str = field(
        default="json", metadata={"help": "corpus format"}
    )
    ...
    corpus_cache_dir: Optional[str] = field(
        default=None, metadata={"help": "Where do you want to store the corpus downloaded from huggingface"}
    )
